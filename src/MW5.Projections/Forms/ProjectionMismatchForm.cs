...
namespace MW5.Projections.Forms
{
    ...
    /// </summary>
    internal partial class ProjectionMismatchForm : Form
    {
        // project projection
        private ISpatialReference _projectProj = null;
        
        // layer projection
        private ISpatialReference _layerProj = null;

        // db to show projection infor
        private readonly IProjectionDatabase _database = null;
