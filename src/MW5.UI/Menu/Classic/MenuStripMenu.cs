...
{
    /// <summary>
    /// Represents MenuStrip implementation of IMenu interface.
    /// </summary>
    internal class MenuStripMenu: MenuBase
    {
        ...
        internal override void CreateDefaultItems()
        {
        ...
        public override IMenuItemCollection Items
        {
            get
            {
                return new MenuStripItemCollection(_menuStrip.Items, _menuIndex);
            }
        }
