// -------------------------------------------------------------------------------------------
// <copyright file="CustomVectorTool.cs" company="MapWindow OSS Team - www.mapwindow.org">
...
namespace MW5.Plugins.TemplatePlugin.Tools.Vector
{
    [GisTool(GroupKeys.TemplateVector, groupDescription: GroupKeys.TemplateVectorDesc, icon: ToolIcon.Vector, parentGroupKey: GroupKeys.TemplateGroup)]
    public class CustomVectorTool : GisTool
    {
        [Input("Input value", 0)]
