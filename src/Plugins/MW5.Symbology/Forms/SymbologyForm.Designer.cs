...
namespace MW5.Plugins.Symbology.Forms
{
    partial class SymbologyForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.udDefaultSize = new NumericUpDownEx(this.components);
            ...
            this.icbCategories = new ImageCombo();
            this.udMaxSize = new NumericUpDownEx(this.components);
            this.udMinSize = new NumericUpDownEx(this.components);
            this.udNumCategories = new NumericUpDownEx(this.components);
            this.udLabelFontSize = new NumericUpDownEx(this.components);
            this.clpLabelFrame = new Office2007ColorPicker(this.components);
            this.icbChartColorScheme = new ImageCombo();
            this.scaleLayer = new ScaleControl();
            this.udMinDrawingSize = new NumericUpDownEx(this.components);
            this.udMinLabelingSize = new NumericUpDownEx(this.components);
            this.scaleControl2 = new ScaleControl();
            this.scaleControl1 = new ScaleControl();
            ...
            this.icbCategories.ComboStyle = ImageComboStyle.ColorSchemeGraduated;
            ...
            this.icbChartColorScheme.ComboStyle = ImageComboStyle.ColorSchemeGraduated;
            ...
            this.scaleLayer.StateChanged += new StateChanged(this.scaleLayer_StateChanged);
            // 
            // udMinDrawingSize
            // 
