...
namespace MW5.Plugins.Symbology.Forms.Symbology
{
    public partial class PolygonForm : MapWindowForm
    {
        ...
        private void Ui2Options(object sender, EventArgs e)
        {
            ...
            // transparency
            _options.Line.AlphaTransparency = transpOutline.Value;
            _options.Fill.AlphaTransparency = transpFill.Value;
        ...
        private void Options2Ui()
        {
            ...
            transpFill.Value = _options.Fill.AlphaTransparency;
            transpOutline.Value = _options.Line.AlphaTransparency;
