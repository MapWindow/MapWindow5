...
namespace MW5.Plugins.Symbology.Forms.Charts
{
    public partial class AddChartsForm : Form
    {
        ...
        private IFeatureSet m_shapefile = null;
        ...
        public AddChartsForm(IFeatureSet sf)
        {
            ...
            if (m_shapefile.GeometryType == MW5.Api.GeometryType.Polygon)
            {
            ...
            else if (m_shapefile.GeometryType == MW5.Api.GeometryType.Polyline)
            {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                m_shapefile.Diagrams.Generate(positioning);
                m_shapefile.Diagrams.SavingMode = PersistenceType.XmlOverwrite;
            }
            finally
            {
                this.Enabled = true;
