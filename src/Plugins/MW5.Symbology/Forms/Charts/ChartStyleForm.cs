...
namespace MW5.Plugins.Symbology.Forms.Charts
{
    ...
    {
        private IFeatureSet _shapefile = null;
        private DiagramsLayer _charts = null;
       ...
       private void btnRefresh_Click(object sender, EventArgs e)
       {
        ...
        private void UpdateFieldColors()
        {
            ...
            {
                var blend = (ColorBlend)schemes[icbColors.SelectedIndex];
                var scheme = ColorSchemeProvider.ColorBlend2ColorScheme(blend);
                if (scheme != null)
                {
